            ...
            {loading ? (
              ...
              staff.map(s => (
                <tr key={s._id} className="hover:bg-white/3 transition-colors">
                  ...
                  <td className="p-4 text-slate-400 text-xs">{s.department || 'N/A'}</td>
                  <td className="p-4 text-slate-400 text-xs capitalize">{s.role}</td>
                  <td className="p-4 text-slate-400 text-xs font-mono">{s.loginId}</td>
                  <td className="p-4 text-slate-400 text-xs">{new Date(s.createdAt).toLocaleDateString()}</td>
                  <td className="p-4">
